...
#if(BATTLE_PASS)
	gCustomBattlePass.LoadXML(gPath.GetFullPath("Custom\\CustomBattlePass.xml"));
#endif

#if(KILL_STREAK)
	gCustomKillStreak.LoadXML(gPath.GetFullPath("Custom\\CustomKillStreak.xml"));
#endif

#if(EXT_MASTER_TREE)
	gCustomExtMasterTree.LoadXML(gPath.GetFullPath("Custom\\CustomExtMasterTree.xml"));
#endif
