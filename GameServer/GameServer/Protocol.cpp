...
void ProtocolCore(BYTE head,BYTE* lpMsg,int size,int aIndex,int encrypt,int serial) // OK
{
	...
	switch(head)
	{
		...
		case 0xD7:
			...
			{
				case 0x01:
					gCustomBattlePass.CGBattlePassInfoReq(aIndex);
					break;
				case 0x02:
					gCustomBattlePass.CGBattlePassClaimReq((PMSG_BATTLEPASS_CLAIM_REQ*)lpMsg, aIndex);
					break;
			}
			break;
#endif
		...
		case 0xD8:
			...
			{
				case 0x01:
					gCustomExtMasterTree.CGExtMasterInfoReq(aIndex);
					break;
				case 0x02:
					gCustomExtMasterTree.CGExtMasterInvestReq((PMSG_EXT_MASTER_INVEST_REQ*)lpMsg, aIndex);
					break;
			}
			break;
#endif
