...
void CCustomMarriage::CommandPropuse(LPOBJ lpObj,char* arg) // OK
{
	...
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0,gMessage.GetMessage(556),this->m_WeddingItemCount,gItemManager.GetItemName1(this->m_WeddingItemIndex,this->m_WeddingItemLevel));
		return;
	}
...
void CCustomMarriage::CommandDivorce(LPOBJ lpObj) // OK
{
	...
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0,gMessage.GetMessage(564),this->m_DivorseItemCount,gItemManager.GetItemName1(this->m_DivorseItemIndex,this->m_DivorseItemLevel));
		return;
	}
