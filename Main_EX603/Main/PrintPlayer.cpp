...
void InitPrintPlayer() // OK
{
	...
	SetCompleteHook(0xE8,0x0077FB20,&PrintPlayerLevel);

	SetCompleteHook(0xE8,0x0077FB60,&PrintPlayerLevel);
...
{
	wsprintf(a,gCustomMessage.GetMessage(0),*(WORD*)(*(DWORD*)(MAIN_CHARACTER_STRUCT)+0x0E),ViewReset,ViewMasterReset);
}
