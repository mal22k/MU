...
void CProtect::CheckPluginFile6() // OK
{
	...
	if (CRC32.FileCRC(this->m_MainInfo.PluginName6, &Plugin6CRC32, 1024) == 0)
	{
		MessageBox(0, "Plugin CRC error!", "Error", MB_OK | MB_ICONERROR);
		ExitProcess(0);
	}
...
void CProtect::CheckPluginFile7() // OK
{
	if (this->m_MainInfo.Plugin7CRC32 == 0)
	{
		return;
	...
	if (CRC32.FileCRC(this->m_MainInfo.PluginName7, &Plugin7CRC32, 1024) == 0)
	{
		MessageBox(0, "Plugin CRC error!", "Error", MB_OK | MB_ICONERROR);
		ExitProcess(0);
	}
...
void CProtect::CheckPluginFile8() // OK
{
	...
	if (CRC32.FileCRC(this->m_MainInfo.PluginName8, &Plugin8CRC32, 1024) == 0)
	{
		MessageBox(0, "Plugin CRC error!", "Error", MB_OK | MB_ICONERROR);
		ExitProcess(0);
	}
...
void CProtect::CheckPluginFile9() // OK
{
	...
	if (CRC32.FileCRC(this->m_MainInfo.PluginName9, &Plugin9CRC32, 1024) == 0)
	{
		MessageBox(0, "Plugin CRC error!", "Error", MB_OK | MB_ICONERROR);
		ExitProcess(0);
	}
...
void CProtect::CheckPluginFile10() // OK
{
	...
	if (CRC32.FileCRC(this->m_MainInfo.PluginName10, &Plugin10CRC32, 1024) == 0)
	{
		MessageBox(0, "Plugin CRC error!", "Error", MB_OK | MB_ICONERROR);
		ExitProcess(0);
	}
