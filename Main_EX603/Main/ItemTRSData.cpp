...
float cCustomPosition::GetItemTRSDataScaleDrop(int ItemIndex) // OK
{
	std::map<int, CUSTOM_POSITION_INFO>::iterator it = this->m_ItemTRSData.find(ItemIndex);

	if(it != this->m_ItemTRSData.end())
	{
		return it->second.ScaleDrop;
	}
	return 0;
}
...
void cCustomPosition::CustomPosition(int a1, int a2, int a3, int a4, VAngle* a5, int a6, char a7)
{
	...
	if(g_CustomPet.CheckCustomPetByItem(a1 - 1171))
	{
		a1 = g_CustomPet.GetInfoByItemInventory(a1 - 1171);
	}
						...
						if ( (a1 < 5306 || a1 > 5311) && a1 != 5349 )
						{
							...
							else if ( a1 != 3241 && a1 != 3242 )
							{
								...
								default:
									...
									else if( g_CustomPet.CheckCustomPetByItem(a1 - 1171) )
									{
...
//-- INICIA LO CUSTOM
		...
		if(ItemTRSData.GetItemTRSData(a1 - 1171)){
			...
			else if (g_CustomPet.CheckCustomPetByItem(a1 - 1171))
			{
				...
				v19.m_Model.Scale *= g_CustomPet.GetScaleInv(a1 - 1171);
			}
		}
